...
0000000000400fce <func4>: # 1st arg = rdi = 1st input, 2nd arg = rsi = 0
  400fce:	48 83 ec 08          	sub    $0x8,%rsp   # rsp -= 8
  400fd2:	89 d0                	mov    %edx,%eax   # eax = edx = 0xe
  400fd4:	29 f0                	sub    %esi,%eax   # eax = eax - esi = 0xe - esi (first round, esi = 0 )
  ...
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  #jump to l1
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx      # edx = rcx - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax           # eax = eax * 2
  400ff0:	eb 15                	jmp    401007 <func4+0x39> # ret
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax             # .L1
  400ff7:	39 f9                	cmp    %edi,%ecx             # if ecx >= edi ret
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx     # rcx = 2nd input addr
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx     # rdx = 1st input addr
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax             # read two argument
  40102c:	75 07                	jne    401035 <phase_4+0x29> # jump to BOMB
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e> # if 1st input < 15 jump to L1
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx             # .L1
  40103f:	be 00 00 00 00       	mov    $0x0,%esi             # esi = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi        # edi = 1st input
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax            # need return value be 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)       # need 2nd input = 0
...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax              # need 6 bytes strings
  401082:	74 4e                	je     4010d2 <phase_5+0x70>  # jump to L1
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx     # .L2     ecx = pointer to input string + rax
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx          # rdx = cl
  401096:	83 e2 0f             	and    $0xf,%edx            # rdx = cl (zero out other bits)
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax             # rax is the loop index
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> #jump to L2
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi       # need the 0x10(%rsp) == flyers
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> # jump to L3
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax             # .L1
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29> # jump to L2
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax       # .L3
...
00000000004010f4 <phase_6>:
  ...
  401114:	4c 89 ed             	mov    %r13,%rbp  # rbp = r13  ##.L2
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # eax = (r13)
  40111b:	83 e8 01             	sub    $0x1,%eax        # (r13) = (r13) - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> # need (r13) - 1 <= 5, otherwise BOMB
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d        # r12d += 1 (1 2 3 4 5)
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f> # if r12d == 6, jump to L1
  401132:	44 89 e3             	mov    %r12d,%ebx           # ebx = r12d
  401135:	48 63 c3             	movslq %ebx,%rax            # sign extend r12d  ##.L3
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax   # eax = r12d th number of input
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> # (rsp + 4*rax) different from (rbp)
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx           # ebx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41> # if ebx <= 5, jump to .L3
  40114d:	49 83 c5 04          	add    $0x4,%r13             # r13 += 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # jump to L2
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi       #  rsi = rsp + 0x18 ##.L1
###################################################################################################
  401158:	4c 89 f0             	mov    %r14,%rax         # rax = r14 = rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx         # ecx = 7  .L4
  401160:	89 ca                	mov    %ecx,%edx         # edx = ecx
  401162:	2b 10                	sub    (%rax),%edx       # edx -= (rax)
  401164:	89 10                	mov    %edx,(%rax)       # (rax) = edx  { (rax) = 7 - (rax) }
  401166:	48 83 c0 04          	add    $0x4,%rax         # rax += 4 { next elem }
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # if rsi != rax ( rax != rsp + 18 ) jump to .L4
###################################################################################################
  40116f:	be 00 00 00 00       	mov    $0x0,%esi             # clear rsi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> # jump to M1
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx       # rdx = (rdx + 8) { next node } ##.M4
  40117a:	83 c0 01             	add    $0x1,%eax           # eax += 1
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>  # if ecx != eax jump to M4 else jump to M5
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx   # edx = 0x6032d0 ##.M2
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # (rsp + 2 * rsi + 0x20) = rdx { rdx is address of the node }  ##.M5
  40118d:	48 83 c6 04          	add    $0x4,%rsi              # rsi += 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7> # if rsi == 0x18 { load 6 times } jump to M3
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx   # ecx = (rsp + rsi)  ##.M1
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # if ecx <= 1 jump to  .M2
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax             # eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx        # edx = 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> # jump to M4
# PUT THE ADRESS OF NODE BY THE GIVEN ORDER
###################################################################################################
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx       # rbx = (rsp + 0x20) ##.M3
  ...
  4011bd:	48 8b 10             	mov    (%rax),%rdx           # rdx = (rax)  ##.M5
  ...
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> # jump to M5 { loop all node }
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)       # last elem's *next point to NULL
  4011d9:	00 
###################################################################################################
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> # need (rbx) > ((rbx + 8)) unsigned
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx        # rbx = (rbx + 8)
  4011f2:	83 ed 01             	sub    $0x1,%ebp             # ebp - 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>
# CHECK THE LINKED LIST IN DECREASING ORDER
###################################################################################################
...
0000000000401204 <fun7>:
  ...
  40120b:	74 2b                	je     401238 <fun7+0x34> # if rdi == 0 go to DEAD
  40120d:	8b 17                	mov    (%rdi),%edx        # edx = (rdi)
  40120f:	39 f2                	cmp    %esi,%edx
  401211:	7e 0d                	jle    401220 <fun7+0x1c> # if (rdi) <= rsi go to L1
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi     # rdi = next node
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax          # eax = 2 * eax
  40121e:	eb 1d                	jmp    40123d <fun7+0x39> # go to end
  401220:	b8 00 00 00 00       	mov    $0x0,%eax         # .L1
  401225:	39 f2                	cmp    %esi,%edx
  401227:	74 14                	je     40123d <fun7+0x39> # if edx == esi go to end
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  401236:	eb 05                	jmp    40123d <fun7+0x39>
  401238:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  40123d:	48 83 c4 08          	add    $0x8,%rsp   # .END
  401241:	c3                   	retq   
...
0000000000401242 <secret_phase>:
  ...
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>            # one input which is integer
  40125a:	48 89 c3             	mov    %rax,%rbx
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax                    # need input - 1 < 1000
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>     # if eax < 0x3e8 jump to .L1
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi                       # second args = esi = input int .L1
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi                  # frist args = edi = 0x6030f0
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax          # if eax == 2, go to L2, defuse phase
  40127b:	74 05                	je     401282 <secret_phase+0x40>
  40127d:	e8 b8 01 00 00       	callq  40143a <explode_bomb>
  401282:	bf 38 24 40 00       	mov    $0x402438,%edi               # ##.L2 the point to the congratulations message
...
00000000004015c4 <phase_defused>:
  ...
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b> # if not equal to 6,  end normally
  ...
  40163f:	48 8b 44 24 68       	mov    0x68(%rsp),%rax         ## .L1
